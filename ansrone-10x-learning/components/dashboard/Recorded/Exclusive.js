import styles from "../../../styles/dashboard/Exclusive.module.css";
import { useEffect, useState } from "react";
import TopicCard from "./TopicCard";

const Exclusive = ({ lectures = [] }) => {
    ...
    useEffect(() => {
        ...
        lectures.forEach((lecture) => {
            if (!temp.includes(lecture.topicId)) temp.push(lecture.topicId);
        });
